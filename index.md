...
| 랩 | 내용 | 시간 |
|---|---|---|
| [중급 Lab 4. 적재 흐름](./docs/lab4.html) | 메일 → AI 추출 → SharePoint | 50분 |
| ↳ [중급 Lab 4-대안 (Outlook 미사용)](./docs/lab4-alt.html) | 메일 대신 수동 실행 — Lab 4를 **대체** | 40분 |
| [중급 Lab 5. 승인 흐름](./docs/lab5.html) | 비동기 HITL — 사람이 요약을 보증 | 40분 |
| [중급 Lab 6. AI 적합도 반영](./docs/lab6.html) | 두 겹 게이트로 안전한 갱신 | 30분 |
| [중급 Lab 7. 전형단계 변경](./docs/lab7.html) | 대화형 HITL — 토픽 + 확인 카드 | 60분 |

**2부 합계 3시간** (Lab 4-대안은 Lab 4를 대체하므로 합계에서 제외).

{: .note }
Outlook을 쓸 수 없다면 Lab 4 대신 [중급 Lab 4-대안](./docs/lab4-alt.html)으로 진행하세요. 트리거만 다를 뿐 결과물은 동일하고, **Lab 5 이후는 어느 쪽으로 진행했든 같습니다.**
