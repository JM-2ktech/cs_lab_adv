...
>
> [핸즈온 인트로 슬라이드 내려받기 (pptx)](../../assets/advanced/download/핸즈온%20인트로%20영상%20제거버전.pptx)
...
<!-- 저작 메모(학생 비노출):
     ...
     ★ 오리엔테이션 pptx(assets/download/)와 내용이 대응한다 — 슬라이드 10(세 도구)·11(두 가지 질문)·19(용어)·20(랩 구성)이 이 페이지와 홈에 흩어져 있다.
       ...
       ⚠️ 이 덱은 CJ 전용 트랙이다 — 중간 스크린샷에 CJ 환경이 다수 포함되어 다른 고객사에 그대로 쓸 수 없다. 고객사별 별도 버전으로 관리할 것.
