...
> ## ⚠️ 시작 전에 — 환경부터 확인하세요
>
> Copilot Studio 우측 상단 **환경**이 **`2026 에이전트 교육 및 지원`** 인지 **반드시** 확인합니다. Lab 1에서 솔루션을 열었던 그 환경입니다.
>
> **다른 환경(기본 환경 등)에서 만들면 이후 랩이 전부 막힙니다.** 에이전트는 만들어지지만 Lab 1에서 만든 목록도, Lab 6·7에서 붙일 흐름도 보이지 않습니다. 그때는 **처음부터 다시 만들어야 합니다.**
>
